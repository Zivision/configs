...
- [[#dev-settings][Dev Settings]]
  ...
  - [[#packages-1][Packages]]
    ...
    - [[#fonts-for-packages][Fonts for packages]]
...
- [[#configuration-settings][Configuration Settings]]
  ...
  - [[#configuration][Configuration]]
    ...
    - [[#nix-packages][Nix Packages]]
      - [[#start-of-list-2][Start of List]]
      - [[#sway-lock-lock-screen][Sway Lock (Lock Screen)]]
      - [[#flatpak-1][Flatpak]]
      - [[#end-of-list-3][End of List]]
...
* Dev Settings
:PROPERTIES:
:header-args: :tangle ../build/nixos/dev.nix
:VISIBILITY: folded
:END:
** Imports
#+begin_src nix
...
** Laptop
:PROPERTIES:
:header-args: :tangle ../build/nixos/laptop.nix
:VISIBILITY: folded
:END:
One of my laptops
#+begin_src nix
...
** Main Box
:PROPERTIES:
:header-args: :tangle ../build/nixos/main-box.nix
:VISIBILITY: folded
:END:
Main Box
#+begin_src nix
...
** WSL
:PROPERTIES:
:header-args: :tangle ../build/nixos/wsl.nix
:VISIBILITY: folded
:END:
#+begin_src nix
{
