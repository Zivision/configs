...
- [[#config-settings][Config Settings]]
  ...
  - [[#basic-settings][Basic settings]]
    ...
    - [[#window-alist-window-behavior][Window Alist (window behavior)]]
...
- [[#packages-settings][Packages Settings]]
  ...
  - [[#external-packages][External Packages]]
    ...
    - [[#ui-1][UI]]
      ...
      - [[#golden-ratio-window-resize][Golden Ratio (Window resize)]]
      - [[#beacon-1][Beacon]]
    - [[#elfeed-2][Elfeed]]
      - [[#elfeed-tube-1][Elfeed Tube]]
    - [[#misc][Misc]]
      - [[#aio][AIO]]
      - [[#mpv][MPV]]
    - [[#fun][Fun]]
...
- [[#internal-packages][Internal Packages]]
  - [[#tangle-configs-1][Tangle Configs]]
    - [[#header--metadata][Header & Metadata]]
    - [[#manual-link-firefox][Manual Link Firefox]]
      - [[#search-folder-for-prefsjs][Search Folder for prefs.js]]
      - [[#link-it][Link it]]
    - [[#build-directories][Build Directories]]
    - [[#configure-function][Configure Function]]
      - [[#make-directories][Make Directories]]
      - [[#create-symlink][Create Symlink]]
      - [[#babel-org-documents][Babel Org Documents]]
      - [[#create-manual-symlinks][Create Manual symlinks]]
...
Currently in this configuration there is {{{word-count}}} words
...
* Init Settings
:PROPERTIES:
:header-args: :tangle ../build/doom/init.el
:VISIBILITY: folded
:END:
...
* Config Settings
:PROPERTIES:
:header-args: :tangle ../build/doom/config.el
:VISIBILITY: folded
:END:
...
* Packages Settings
:PROPERTIES:
:header-args: :tangle ../build/doom/packages.el
:VISIBILITY: folded
:END:
...
** Tangle Configs
:PROPERTIES:
:header-args: :tangle ../build/doom/elisp/tangle-configs.el
:VISIBILITY: folded
:END:
...
#+end_src
**** Search Folder for prefs.js
Finds profile folders created by firefox
#+begin_src elisp
  (let ((paths
         (mapcar
          (lambda (path)
...
*** Build Directories
This is for making the directories in the build directory automatically
#+begin_src elisp
...
**** Create Symlink
This snippet creates a link between system hardware-configuration.nix and the
local nix files in this project.
#+begin_src elisp
...
**** Babel Org Documents
This takes each file in the *org/* directory and creates the corresponding files
needed.
#+begin_src elisp
...
This is a simple interactive wrapper. It isn't much but works okay, need improvement.
