...
-  [[#xonsh-xonsh-directory][Xonsh (xonsh/ directory)]]
  -  [[#imports-2][Imports]]
  -  [[#variables][Variables]]
  -  [[#theme-1][Theme]]
...
$xonsh = emacsclient -c -e '(hypr/launch-custom-shell "xonsh")'
#+end_src
**  Autostart
#+begin_src conf
exec-once = waybar
...
bind = $mainMod SHIFT, W, exec, $xonsh
...
#+end_src
*  Xonsh (xonsh/ directory)
:PROPERTIES:
:header-args: :tangle ./xonsh/rc.py
:VISIBILITY: folded
:END:
